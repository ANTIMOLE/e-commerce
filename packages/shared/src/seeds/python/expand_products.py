...
SOURCE = os.path.join(BASE_DIR, "../../dataset/tokopedia_20000.csv")
OUTPUT = os.path.join(BASE_DIR, "../../dataset/tokopedia_50000.csv")
...
synth = (
    df.sample(n=synth_n, replace=True, random_state=SEED).copy().reset_index(drop=True)
)
