...
USERS_OUT = os.path.join(BASE_DIR, "../../dataset/users_seed.csv")
ADDR_OUT = os.path.join(BASE_DIR, "../../dataset/addresses_seed.csv")
...
ADDRESS_PREFIXES = ["Jl.", "Jalan", "Gg.", "Komplek", "Perumahan", "Blok"]
STREET_NAMES = [
    "Merdeka",
    "Sudirman",
    "Diponegoro",
...
for u in regular_users:
    chosen_cities = random.sample(
        CITY_PROVINCE_ZIP, k=min(ADDR_PER_USER, len(CITY_PROVINCE_ZIP))
    )
